...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form method="post" action="{{route('expenses.update',['expense'=>$expense->id,'category'=>$categoryId,'user'=>$userId])}}">
            <div class="card">
                <div class="card-header">
                    Edit {{$expense->name}} expense
                </div>
                <div class="card-body">
                    @if (session('status'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="expense_value" value="{{$expense->expense_value}}" step="0.01">
                    </div>
